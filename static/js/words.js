  ...
  btn.onclick = function() {
    if (key.value === "lxr&gz") {
      ...
      const words = [
        ...
        "I'm very happy you are with me today,",
        "so I can hug and kiss you.",
        "To celebrate our growing love,",
        "I prepared 3 gifts for you,",
        "I hope you like them.",
        "The outside is quite dangerous now,",
        "I wish all get better.",
        "And there are countless places to explore for us.",
        "We have been together for nearly 4 months,",
        "and our love doesn't fade at all.",
        "We are mean to be together.",
        "I have met your families, and so do you,",
        "luckily things go well.",
        "Maybe we have xiaoBenBen soon.",
        "I love you!",
        "Yours Gorden."
      ];
      let i = 0;
